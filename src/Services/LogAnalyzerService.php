...
class LogAnalyzerService
{
    ...
    public function analyze(string $logContent, ?string $model = null): string
    {
        ...
        $modelToUse = $model ?? config('log-analyzer.model', 'gemini-2.5-flash');
        $endpoint = 'https://generativelanguage.googleapis.com/v1beta/models/' . rawurlencode($modelToUse) . ':generateContent?key=' . $this->apiKey;
